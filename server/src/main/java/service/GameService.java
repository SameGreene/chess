            ...
            for (int i = 0; i < gameObj.gameList.size(); i = i + 1) {
                ...
                if (gameObj.gameList.get(i).gameID() == req.getGameID()) {
                    if (req.playerColor.equals(null)) {
                        ...
                        if (req.getPlayerColor().equals("WHITE") && gameObj.gameList.get(i).whiteUsername() != null) {
                            ...
                            gameObj.gameList.remove(i);
                            gameObj.gameList.add(gameToUpdate);
                            return new JoinGameResponse("", 200);
                        } else if (req.getPlayerColor().equals("BLACK") && gameObj.gameList.get(i).blackUsername() != null) {
